...
export default function elementSelectionHandler<WT extends boolean, ON extends OptionNode>(withText: WT, getNewOptionNode: GetNewOptionNode<WT, ON>, insertInNewLine: boolean, element: HTMLElement) {
