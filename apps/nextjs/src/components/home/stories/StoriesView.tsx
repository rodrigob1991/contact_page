...
/* 
    ...
    if (viewMode === "reading") {
        ...
        const {htmlEditorModal} = useHtmlEditor({positionType: "selection", getContainerRect: () => getContainerDiv()?.getBoundingClientRect(), options: {defaultTextClassName: "fixe me"}, doesTargetContains: doesStoriesBodiesContains})
