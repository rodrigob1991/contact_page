...
import {AnyPropertiesCombination} from "../../../../../common/src/utils/Types"
import {
    EditHomeProps,
    Image,
    NewSkill,
...
import {getContainedString} from "../../../../../common/src/utils/Strings"
...
export default function EditHome(props: EditHomeProps) {
