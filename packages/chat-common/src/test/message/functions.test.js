...
const uackToGuessMessage = `${uackPrefix}:${number}`;
const expectedUackToGuessMessageParts = { prefix: uackPrefix, number: number };
const gotUackToGuessMessageParts = (0, functions_1.getMessageParts)(uackToGuessMessage, { prefix: 1, number: 2 });
equalParts(expectedUackToGuessMessageParts, gotUackToGuessMessageParts, "uack", "guess", "out");
const sackToGuessMessage = `${sackPrefix}:${number}`;
const expectedSackToGuessMessageParts = { prefix: sackPrefix, number: number };
const gotSackToGuessMessageParts = (0, functions_1.getMessageParts)(sackToGuessMessage, { prefix: 1, number: 2 });
...
const uackToHostMessage = `${uackPrefix}:${number}:${guessId}`;
const expectedUackToHostMessageParts = { prefix: uackPrefix, number: number, guessId: guessId };
const gotUackToHostMessageParts = (0, functions_1.getMessageParts)(uackToHostMessage, { prefix: 1, number: 2, guessId: 3 });
equalParts(expectedUackToHostMessageParts, gotUackToHostMessageParts, "uack", "host", "out");
const sackToHostMessage = `${sackPrefix}:${number}:${guessId}`;
const expectedSackToHostMessageParts = { prefix: sackPrefix, number: number, guessId: guessId };
const gotSackToHostMessageParts = (0, functions_1.getMessageParts)(sackToHostMessage, { prefix: 1, number: 2, guessId: 3 });
...
const ackFromGuessMessage = `${uackPrefix}:${originPrefix}:${number}`;
const expectedAckFromGuessMessageParts = { prefix: uackPrefix, originPrefix: originPrefix, number: number };
...
const ackFromHostMessage = `${uackPrefix}:${originPrefix}:${number}:${guessId}`;
const expectedAckFromHostMessageParts = { prefix: uackPrefix, originPrefix: originPrefix, number: number, guessId: guessId };
