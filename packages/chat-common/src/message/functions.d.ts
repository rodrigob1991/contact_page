...
export declare const getPrefix: <M extends `mes:${number}:${number}:${string}` | `uack:mes:${number}:${number}` | `uack:uack:${number}:${number}` | `uack:con:${number}:${number}` | `uack:dis:${number}:${number}` | `uack:usrs:${number}` | `con:${number}:${number}:${string}` | `dis:${number}:${number}:${string}` | `sack:${number}:${number}` | `uack:${number}:${number}` | `usrs:${number}:${string}`>(m: M) => M extends `${infer MP}:${string}` ? MP : never;
